  ...
  return (
    <div className={theme.section}>
      <div className={theme.container}>
        ...
        <div className={theme.textCenter + " " + theme.sharingArea}>
          <GridContainer justify="center">
            <h3>Thank you for supporting us!</h3>
          </GridContainer>
          <Button color="twitter">
            <i className={theme.socials + " fab fa-twitter"} /> Tweet
          </Button>
          <Button color="facebook">
            <i className={theme.socials + " fab fa-facebook-square"} /> Share
          </Button>
          <Button color="google">
            <i className={theme.socials + " fab fa-google-plus-g"} />
            Share
          </Button>
          <Button color="github">
            <i className={theme.socials + " fab fa-github"} /> Star
          </Button>
        </div>
      </div>
    </div>
